<style>
   ...
   <?php
    ...
    $sql = "SELECT player_id, name, sum(points) as total_points, sum(villages) as total_villages, sum(wins) as total_wins FROM player GROUP BY player_id ORDER BY total_wins DESC";
